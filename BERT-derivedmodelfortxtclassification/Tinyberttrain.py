...
from Tinybertmodel import TinyBert4TC
...
def train():
    ...
    tokenizer = BertTokenizer.from_pretrained('E:/transformers/TinyBERT_General_6L_768D')
    ...
    model = TinyBert4TC.from_pretrained(args.bert_model, num_labels = args.num_labels)
