...
from albertmodel import Albert4TC
...
def train():
    ...
    tokenizer = AlbertTokenizer.from_pretrained('E:/transformers/models--albert-base-v2/snapshots/eab127d1a4a42b10e2b130e1834c64f5844d541e')
    ...
    model = Albert4TC.from_pretrained(args.bert_model, num_labels = args.num_labels)
