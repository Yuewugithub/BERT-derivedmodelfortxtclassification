...
from Mobilebertmodel import MobileBert4TC
...
def train():
    ...
    tokenizer = BertTokenizer.from_pretrained('E:/transformers/mobilebert-uncase')
    ...
    model = MobileBert4TC.from_pretrained(args.bert_model, num_labels = args.num_labels)
