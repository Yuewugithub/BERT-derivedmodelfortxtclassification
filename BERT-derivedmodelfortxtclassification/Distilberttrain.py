...
def train():
    ...
    tokenizer = DistilBertTokenizer.from_pretrained('E:/transformers/distlbert-base-uncased')
    ...
    model =DistilBert4TC.from_pretrained(args.bert_model, num_labels = args.num_labels)
    ...
    for _ in trange(int(args.epochs), desc = "Epoch"):
        ...
        for step, batch in enumerate(tqdm(train_dataloader, desc = "Iteration")):
            ...
            loss = model(input_ids=input_ids, attention_mask=input_mask, labels=label)
